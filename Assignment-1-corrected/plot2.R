...
x$Sub_metering_1 <- as.numeric(x$Sub_metering_1) # converting to numeric

x$Sub_metering_2 <- as.numeric(x$Sub_metering_2) # converting to numeric

x$Voltage <- as.numeric(x$Voltage)

png("plot2.png", width=480, height=480) # plotting graph
